...
export const bookNow = async (name, phone, customer_id, town, kgs, packaging, discount, transport, transporters, rider, comment, farmer_id, rice_type, vat, farmer_price, price, amount) => {
    const token = await AsyncStorage.getItem(TOKEN_KEY); 
    ...
    try {
        const response = await Axios.post(
            `${BASE_URL}/api/orders/`,
            { name, phone, customer_id, town, kgs, packaging, discount, transport, transporters, rider, comment, farmer_id, rice_type, vat, farmer_price, price, amount },
            {
                headers: {
...
export const fetchAllPaymennt = async () => {
    const token = await AsyncStorage.getItem(TOKEN_KEY); 
